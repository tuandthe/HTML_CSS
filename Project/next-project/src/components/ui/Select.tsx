  ...
  return (
    <div className={cn("relative", className)} ref={containerRef}>
      ...
      <div className="flex items-center gap-3">
        {label && <span className="font-medium text-sm text-gray-900 whitespace-nowrap">{label}
            </span>
            }
        ...
        <button
          ...
          className={cn(
            ...
            isOpen ? "border-[#007042] ring-1 ring-[#007042]" : "hover:border-gray-400"
          )}
        >
          ...
          {normalizedOptions.map((option) => (
            <div
              ...
              className={cn(
                ...
                value === option.value ? "text-[#007042] font-semibold bg-green-50 hover:bg-[#007042] hover:text-white" : "text-gray-900"
              )}
            >
