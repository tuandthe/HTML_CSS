...
export default function ChatBubble({ message, isMe }: ChatBubbleProps) {
  return (
    ...
    >
      ...
      <div className="flex-shrink-0">
        <div 
          className={cn(
            ...
            isMe ? "bg-[#007042] text-white border-[#007042]" : "bg-gray-100 text-gray-500 border-gray-200"
          )}
        >
          <User size={20} />
        </div>
      ...
      >
        <div className={cn("flex items-center gap-2 mb-1.5", isMe && "flex-row-reverse")}>
        ...
        >
          ...
          {message.attachment && (
            ...
            >
              <Paperclip size={16} className={isMe ? "text-white/80" : "text-gray-500"} />
