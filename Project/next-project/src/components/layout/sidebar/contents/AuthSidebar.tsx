  ...
  return (
    <div className="flex flex-col h-full bg-woo-bg lg:bg-woo-card">
      <div className="p-6">
        <Link
          href="/"
          className="flex items-center gap-2 text-woo-secondary hover:text-woo-primary transition-colors"
        >
          <ArrowLeft size={16} />
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-woo-primary/10 text-woo-primary font-medium"
                  : "text-woo-secondary hover:bg-woo-bg hover:text-woo-text",
              )}
            >
              <item.icon size={18} />
              {item.name}
