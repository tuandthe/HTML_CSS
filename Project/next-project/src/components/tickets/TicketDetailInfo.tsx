  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-5 shadow-sm border border-gray-200 bg-white rounded-xl">
        <h3 className="font-bold text-gray-900 mb-4 text-base">Ticket Information</h3>
        <div className="space-y-5 text-sm">
          {/* Category */}
          <div>
            <div className="text-gray-500 mb-2 text-xs font-medium">Category</div>
          ...
          {ticket.orderId && (
            <div>
              <div className="text-gray-500 mb-1 text-xs font-medium">Related Order</div>
          ...
          <div className="space-y-4 pt-1">
            <div>
              <div className="text-gray-500 mb-1 text-xs font-medium">Created</div>
              <div className="font-medium text-gray-900">{ticket.createdDate}</div>
            </div>
            <div>
              <div className="text-gray-500 mb-1 text-xs font-medium">Last Updated</div>
              <div className="font-medium text-gray-900">{ticket.updatedDate}</div>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-5 shadow-sm border border-gray-200 bg-white rounded-xl">
        ...
        <div className="space-y-3">
          <button className="w-full flex items-center gap-3 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm">
            <CheckCircle2 size={18} className="text-gray-500" /> Mark as Resolved
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm">
